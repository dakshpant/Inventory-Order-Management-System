...
type NavigationSection = "dashboard" | "products" | "customers" | "orders";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex" id="app-container">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-slate-900 text-slate-300 border-r border-[#1e293b] shrink-0 select-none">
        ...
        <nav className="flex-1 py-6 px-3 space-y-1 text-sm font-semibold">
          ...
          <button
            ...
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-md transition-colors group ${
          ...
          >
            ...
            {stats.lowStockCount > 0 && (
              <span className="inline-flex items-center justify-center px-2 py-0.5 text-[9px] font-extrabold bg-red-600 text-white rounded-full animate-pulse shadow-xs">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        <header className="h-16 bg-white border-b border-slate-200 px-4 md:px-8 flex items-center justify-between shrink-0 shadow-sm z-30">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              title="Toggle systems terminal navigation"
            >
              {isMobileMenuOpen ? (
                <X className="w-6 h-6" />
              ) : (
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-2 text-slate-400 hover:text-slate-600 rounded-full hover:bg-slate-50 relative transition-colors"
              title={
                stats.lowStockCount
            ...
            <button
              ...
              title="Hard sync registry lists"
            >
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div
              className="absolute top-0 left-0 w-64 h-full bg-slate-900 text-slate-300 flex flex-col p-4 space-y-4 shadow-xl"
            ...
            >
              ...
              <div className="space-y-1 flex-1 text-sm font-semibold">
                <button
                  onClick={() => handleNavClick("dashboard")}
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-md text-left ${activeSection === "dashboard" ? "bg-blue-600/15 text-blue-400 font-bold border-l-2 border-blue-500" : "text-slate-400 hover:bg-slate-800"}`}
                >
                ...
                <button
                  onClick={() => handleNavClick("products")}
                  className={`w-full flex items-center justify-between px-3 py-2.5 rounded-md text-left ${activeSection === "products" ? "bg-blue-600/15 text-blue-400 font-bold border-l-2 border-blue-500" : "text-slate-400 hover:bg-slate-800"}`}
                >
                  <div className="flex items-center gap-2.5">
                  ...
                  {stats.lowStockCount > 0 && (
                    <span className="px-2 py-0.5 text-[9px] bg-red-500 text-white font-extrabold rounded-full">
                      {stats.lowStockCount} alert
                    </span>
                  )}
                </button>
                <button
                  onClick={() => handleNavClick("customers")}
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-md text-left ${activeSection === "customers" ? "bg-blue-600/15 text-blue-400 font-bold border-l-2 border-blue-500" : "text-slate-400 hover:bg-slate-800"}`}
                >
                ...
                <button
                  onClick={() => handleNavClick("orders")}
                  className={`w-full flex items-center gap-2.5 px-3 py-2.5 rounded-md text-left ${activeSection === "orders" ? "bg-blue-600/15 text-blue-400 font-bold border-l-2 border-blue-500" : "text-slate-400 hover:bg-slate-800"}`}
                >
