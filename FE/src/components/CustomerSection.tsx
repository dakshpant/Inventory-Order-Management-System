...
export default function CustomerSection({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email.trim()) return setError("Customer email is required");
  ...
  return (
    <div className="space-y-6 animate-fade-in" id="customer-management-section">
      {/* Top Banner Row */}
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Search by full name, registered email address, or phone digits..."
          value={search}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
        {filteredCustomers.length === 0 ? (
          <div className="col-span-full bg-white border border-slate-200 rounded-xl p-12 text-center text-slate-400 text-xs">
          ...
          filteredCustomers.map((c) => {
            ...
            return (
              <div
                key={c.id}
                className="bg-white border border-slate-200 rounded-xl p-5 hover:border-slate-300 shadow-3xs flex flex-col justify-between"
              >
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs">
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-blue-500 font-mono lowercase"
                />
              </div>
